...
public class TestBlackjackGame {
    ...
    public void testInitialBet() {
        ...
        System.setIn(in);
        game.initialBet();
        assertEquals(game.getHuman().getBetAmount(), 
                playerBet + game.BUY_IN, 0);
        assertEquals(game.getBetSum(game.getPlayers()), 
                game.BUY_IN * (numBotPlayers + 1) + playerBet, 0);
    }
    ...
    public void testDealCard() {
        assertEquals(game.getPlayingDeck().size(), 52);
        PlayingCard card = game.getPlayingDeck()
                .get(game.getPlayingDeck().size() - 1);
    ...
    public void testDealerPaysAllNonBustPlayers() {     
        ...
        assertEquals(game.getDealer().getTotalMoney(), 
                1000f - ((2 * game.BUY_IN) + 5), 0);
