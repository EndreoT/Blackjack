...
public class Player {
    ...
    public int getWins() {return numberOfWins;}
    ...
    public void addToTotalMoney(float amount) {totalMoney += amount;}
    
    public void decreaseFromTotalMoney(float amount) {totalMoney -= amount;}
     
    public void clearBet() {betAmount = 0;}
    
    public void incrementWins() {numberOfWins++;}
  
    public List<PlayingCard> showHand() {return PLAYINGHAND;}
    
    public int getCardTotals() {
        return PLAYINGHAND
            .stream()
            .map(p -> p.getRank().getValue())
    ...
    public void clearHand() {PLAYINGHAND.clear();}
