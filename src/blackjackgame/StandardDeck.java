...
public class StandardDeck {
    ...
    public List getDeck() {return DECK_OF_CARDS;}
    
    public void sortDeck() {
        Collections.sort(DECK_OF_CARDS, Comparator
                .comparing(PlayingCard::getSuit)
                .thenComparing(PlayingCard::getRank));
    }
    
    public void shuffleDeck() {Collections.shuffle(DECK_OF_CARDS);}
}
