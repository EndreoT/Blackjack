...
public class TextView {
    ...
    public void dealingCards() {System.out.println("Dealing cards...");}
    ...
    public void showDealersFaceUpCard(Dealer dealer) {
        System.out.println("Dealer's hand is one face down card and " 
                + dealer.showHand().get(1)
                + ", Shown Total: " + dealer.showHand().get(1).getRank().getValue());
    }
    ...
    public void dealerPays(Map<Player, Float> map) {
        BiConsumer<Player, Float> biConsumer = (key, value) -> System.out.println(key + " receives " + value + " from Dealer.");
